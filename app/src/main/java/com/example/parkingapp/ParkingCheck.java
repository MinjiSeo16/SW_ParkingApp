...
public class ParkingCheck extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView parkingListView = findViewById(R.id.parkingListView);
        ...
        Button loginButton = findViewById(R.id.뒤로가기);
