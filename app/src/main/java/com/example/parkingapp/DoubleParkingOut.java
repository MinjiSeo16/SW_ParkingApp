...
public class DoubleParkingOut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doubleout);
        ...
        cancelButton.setOnClickListener(v -> {
            ...
            Toast.makeText(this,"이중주차 등록이 취소되었습니다.", Toast.LENGTH_SHORT).show();
        });
    ...
    private void deleteParkingUserInfo(int aptId, String region, String regionNum, String phoneNumber) {
        ...
        db.delete("DoubleParkingUserInfo", whereClause, whereArgs);
        db.close();
    }
    private void insertParkingSpaceInfo(int aptId, String region, String regionNum) {
        ...
        db.insert("DoubleParkingSpace", null, values);
        db.close();
    }
