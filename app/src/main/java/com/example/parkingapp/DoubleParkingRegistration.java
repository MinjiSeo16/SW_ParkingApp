...
public class DoubleParkingRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doubleregistration);

        databaseHelper = new ParkingAreaDatabaseHelper(this);
        RegionInput = findViewById(R.id.editTextText2);
        RegionNumInput = findViewById(R.id.editTextNumber3);
        Button RegistrationButton = findViewById(R.id.button11);
        Button CancelRightNowButton = findViewById(R.id.button12);
        Button BackButton = findViewById(R.id.button13);
        ...
        RegistrationButton.setOnClickListener(v -> {
            ...
            if (isParkingSpace((int) aptId, Region, RegionNum)) {
                ...
                Toast.makeText(this,"이중주차가 등록되었습니다.", Toast.LENGTH_SHORT).show();
                ...
                if(isUserTableInfo((int) aptId, Region, RegionNum, phoneNumber)){  //사용자테이블에는 있을 경우
                    ...
                    Intent intent2 = new Intent(DoubleParkingRegistration.this, DoubleParkingOut.class);
    ...
    private void deleteParkingSpaceInfo(int aptId, String region, String regionNum) {
        ...
        db.delete("DoubleParkingSpace", whereClause, whereArgs);
        db.close();
    }
    private boolean isParkingSpace(int aptId, String region, String regionNum) {
        ...
        Cursor cursor = db.query("DoubleParkingSpace", null, selection, selectionArgs, null, null, null);
    ...
    private boolean isUserTableInfo(int aptId, String region, String regionNum,String phoneNumber){
        ...
        Cursor cursor = db.query("DoubleParkingUserInfo", null, selection, selectionArgs, null, null, null);
        boolean exists = cursor != null && cursor.getCount() > 0;
        if (cursor != null) {
            cursor.close();
        }
    ...
    private void insertParkingUserInfo(int aptId, String region, String regionNum, String phoneNumber) {
        ...
        db.insert("DoubleParkingUserInfo", null, values);
        db.close();
    }
}